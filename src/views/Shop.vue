      ...
      <div>
        ...
        >
          ...
          <el-form-item label="店铺头像">
            ...
            >
              <img v-if="shopForm.shopAvatar" :src="baseApi+shopForm.shopAvatar" class="avatar" />
          ...
          <el-form-item label="营业执照">
            ...
            >
              <img
                ...
                :src="baseApi+shopForm.businessLicenseImg "
                class="avatar"
              />
              <i v-else class="el-icon-plus avatar-uploader-icon"></i>
            </el-upload>
          ...
          <el-form-item label="餐饮服务许可证">
            ...
            >
              <img
                ...
                :src="baseApi+shopForm.cateringServiceLicenseImg"
                class="avatar"
              />
              <i v-else class="el-icon-plus avatar-uploader-icon"></i>
            </el-upload>
          ...
          <el-form-item label="优惠活动">
            <el-select @change="handleChange" v-model="shopForm.specialOffer" placeholder="请选择活动分类">
...
export default {
  data() {
    return {
      baseApi: "http://127.0.0.1:5000/upload/shop/",
      shopForm: {
        shopname: "", // 名称
        address: "", // 地址
        phone: "", // 电话
        ...
        minprice: 20, // 起送价
        date: [new Date(2019, 11, 17, 6, 0), new Date(2019, 11, 17, 12, 0)], // 营业时间
        shopAvatar: "", // 店铺头像
  ...
  methods: {
    ...
    handleAvatarSuccess1(res, file) {
      this.shopForm.shopAvatar = res.imgUrl;
    },
    handleAvatarSuccess2(res, file) {
      this.shopForm.businessLicenseImg = res.imgUrl;
    },
    handleAvatarSuccess3(res, file) {
      this.shopForm.cateringServiceLicenseImg = res.imgUrl;
    },
    // 上传之前限制
